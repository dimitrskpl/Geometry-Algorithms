...
def ch_times_table(p_sets):
    ...
    _, div_conq_times = ch_multi_psets(div_a_conq_algo.div_and_qonquer_algo, p_sets)
...
def all_2D_algos_ch(points, print_ch=False, plot=False):
    ...
    ch_div_conq, time_div_conq = div_a_conq_algo.div_and_qonquer_algo(points)
...
########################################################################################################################################################
## Convex Hull Algorithms executed for different 
## points sets that contain collinear points
...
## Convex Hull Algorithms executed for 80 random points 
def all_algo_ch_80():
...
def div_conquer_visualize():
    ...
    ch_div_conq, _ = div_a_conq_algo.div_and_qonquer_algo(points=points, plot=True, full_close=True)
    print(ch_div_conq)


## Comparing the convex hull algorithms based on time and quality of the result
...
## Computing and plotting convex hull for 50 random 3D points
def ch_50_3D():
